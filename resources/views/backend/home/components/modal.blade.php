            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group" id="duration">
                        ...
                        <div class="flex">
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == $interval) selected @endif" data-value="{{ $interval }}">{{ $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 2 * $interval) selected @endif" data-value="{{ 2 * $interval }}">{{ 2 * $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 3 * $interval) selected @endif" data-value="{{ 3 * $interval }}">{{ 3 * $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 4 * $interval) selected @endif" data-value="{{ 4 * $interval }}">{{ 4 * $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 5 * $interval) selected @endif" data-value="{{ 5 * $interval }}">{{ 5 * $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 6 * $interval) selected @endif" data-value="{{ 6 * $interval }}">{{ 6 * $interval }}M</button>
                            <button type="button" class="btn btn-default item @if($order != null && $order->duration == 7 * $interval) selected @endif" data-value="{{ 7 * $interval }}">{{ 7 * $interval }}M</button>
