...
<head>
    ...
    <meta name="description" content="Seksuaaltervise Kliinik, Mardi 3 Tallinn">
    <meta name="keywords" content="Seksuaaltervise Kliinik, Mardi 3 Tallinn">
    <meta name="author" content="BOOKid">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Seksuaaltervise Kliinik, Mardi 3 Tallinn</title>
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::user()->name }}  </span><span class="user-status">Admin</span></div><span class="avatar"> <img class="round" src="{{asset('assets/backend/app-assets/images/person-icon.png')}}" alt="avatar" height="40" width="40"></span>
                    </a>
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ route('index') }}">
                        <h2 class="text-white text-bold">Seksuaaltervis</h2>
